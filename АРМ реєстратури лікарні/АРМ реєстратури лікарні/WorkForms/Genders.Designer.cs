namespace АРМ_реєстратури_лікарні
{
	partial class Genders
	{
		...
		private void InitializeComponent()
		{
			...
			this.Gender_ID_TextBox = new System.Windows.Forms.TextBox();
			...
			// Gender_TextBox
			// 
			this.Gender_TextBox.Location = new System.Drawing.Point(553, 139);
			this.Gender_TextBox.Name = "Gender_TextBox";
			this.Gender_TextBox.Size = new System.Drawing.Size(300, 22);
			this.Gender_TextBox.TabIndex = 15;
			// 
			// label11
			// 
			this.label11.AutoSize = true;
			this.label11.Location = new System.Drawing.Point(566, 120);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(54, 16);
			this.label11.TabIndex = 14;
			this.label11.Text = "Гендер";
			// 
			// Report_Button
			// 
			...
			// Gender_ID_TextBox
			// 
			this.Gender_ID_TextBox.Location = new System.Drawing.Point(397, 139);
			this.Gender_ID_TextBox.Name = "Gender_ID_TextBox";
			this.Gender_ID_TextBox.Size = new System.Drawing.Size(150, 22);
			this.Gender_ID_TextBox.TabIndex = 5;
			// 
			// label3
			// 
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.Gender_TextBox);
			this.groupBox1.Controls.Add(this.label11);
			this.groupBox1.Controls.Add(this.Gender_ID_TextBox);
		...
		private System.Windows.Forms.TextBox Gender_ID_TextBox;
